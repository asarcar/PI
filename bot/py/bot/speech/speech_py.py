...
def speech_to_text_ibm_rest(raw_audio):
    print "IBM Transcribing... "
    endpoint = 'https://stream.watsonplatform.net/speech-to-text/api/v1/recognize'
    auth = "Basic " + base64.b64encode('%s:%s'%(FLAGS.ibm_stt_username, FLAGS.ibm_stt_password))
    ...
    r = requests.post(endpoint, data=raw_audio, headers=headers,
        params=payload)
    jsonObject = r.json()
    ...
    # regular hypothesis
      ...
      print 'Decoded Audio: "{}"'.format(hypothesis.decode('utf8'))
